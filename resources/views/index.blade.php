...
<html class="no-js" lang="en">
	...
	<body>
        ...
        <section id="home" class="welcome-hero" style="background-image:url({{ filter_var($homeslider->image, FILTER_VALIDATE_URL) ? $homeslider->image : Voyager::image( $homeslider->image ) }}); background-repeat: no-repeat;">
			<div class="container">
        ...
        <section id="statistics"  class="statistics" style="background-image:url({{ filter_var($slider->image, FILTER_VALIDATE_URL) ? $slider->image : Voyager::image( $slider->image ) }}); background-repeat: no-repeat;"">
			<div class="container">
                        ...
                        <div class="col-md-4 col-sm-6">
							<div class="single-blog-item">
								<div class="single-blog-item-img">
									<img src= "{{ filter_var($post->image, FILTER_VALIDATE_URL) ? $post->image : Voyager::image( $post->image ) }}" alt="blog image">
								</div>
								<div class="single-blog-item-txt">
									<h2><a href="#"> {{ $post->title }} </a></h2>
									<h4>posted <span>by</span> <a href="#">{{ ($post->author->name) }} </a>{{ ($post->created_at)->format('M Y') }}</h4>
                                    {{-- <div>
